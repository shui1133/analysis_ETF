...
def _fetch_twse_fundamentals(ticker: str) -> dict:
    ...
    STATIC_FUNDAMENTALS = {
        ...
        '2330': {'pe_ratio': 22.5, 'pb_ratio': 6.8, 'eps': 45.25, 'roe': 0.32,
                 ...
                 '52w_high': 1150.0, '52w_low': 780.0, 'div_yield_pct': 1.8,
        ...
        '2454': {'pe_ratio': 18.2, 'pb_ratio': 5.1, 'eps': 98.5, 'roe': 0.28,
                 ...
                 '52w_high': 1350.0, '52w_low': 920.0, 'div_yield_pct': 3.32,
        ...
        '2303': {'pe_ratio': 16.8, 'pb_ratio': 2.1, 'eps': 4.2, 'roe': 0.12,
                 ...
                 '52w_high': 58.0, '52w_low': 36.0, 'div_yield_pct': 5.2,
        ...
        '2317': {'pe_ratio': 11.5, 'pb_ratio': 1.8, 'eps': 10.8, 'roe': 0.16,
                 ...
                 '52w_high': 225.0, '52w_low': 145.0, 'div_yield_pct': 2.96,
        ...
        '2382': {'pe_ratio': 15.3, 'pb_ratio': 4.2, 'eps': 32.5, 'roe': 0.27,
                 ...
                 '52w_high': 320.0, '52w_low': 195.0, 'div_yield_pct': 4.64,
        ...
        '2308': {'pe_ratio': 21.0, 'pb_ratio': 5.5, 'eps': 20.1, 'roe': 0.26,
                 ...
                 '52w_high': 450.0, '52w_low': 290.0, 'div_yield_pct': 0.50,
        ...
        '2357': {'pe_ratio': 14.8, 'pb_ratio': 2.8, 'eps': 65.0, 'roe': 0.19,
                 ...
                 '52w_high': 560.0, '52w_low': 340.0, 'div_yield_pct': 3.5,
        ...
        '3008': {'pe_ratio': 35.2, 'pb_ratio': 9.8, 'eps': 168.0, 'roe': 0.27,
                 ...
                 '52w_high': 2500.0, '52w_low': 1600.0, 'div_yield_pct': 1.2,
        ...
        '2395': {'pe_ratio': 20.5, 'pb_ratio': 3.1, 'eps': 20.5, 'roe': 0.15,
                 ...
                 '52w_high': 440.0, '52w_low': 280.0, 'div_yield_pct': 3.8,
        ...
        '4938': {'pe_ratio': 9.8, 'pb_ratio': 1.5, 'eps': 5.8, 'roe': 0.15,
                 ...
                 '52w_high': 72.0, '52w_low': 45.0, 'div_yield_pct': 7.5,
        ...
        '2881': {'pe_ratio': 13.2, 'pb_ratio': 1.5, 'eps': 5.8, 'roe': 0.115,
                 ...
                 '52w_high': 92.0, '52w_low': 68.0, 'div_yield_pct': 5.5,
        ...
        '2882': {'pe_ratio': 14.0, 'pb_ratio': 1.6, 'eps': 5.2, 'roe': 0.11,
                 ...
                 '52w_high': 82.0, '52w_low': 58.0, 'div_yield_pct': 5.2,
        ...
        '2891': {'pe_ratio': 11.5, 'pb_ratio': 1.3, 'eps': 3.2, 'roe': 0.112,
                 ...
                 '52w_high': 42.0, '52w_low': 30.0, 'div_yield_pct': 5.8,
        ...
        '2886': {'pe_ratio': 10.8, 'pb_ratio': 1.1, 'eps': 2.8, 'roe': 0.105,
                 ...
                 '52w_high': 38.5, '52w_low': 26.5, 'div_yield_pct': 6.2,
        ...
        '1301': {'pe_ratio': 18.5, 'pb_ratio': 1.3, 'eps': 4.8, 'roe': 0.07,
                 ...
                 '52w_high': 98.0, '52w_low': 68.0, 'div_yield_pct': 4.8,
        ...
        '1303': {'pe_ratio': 16.2, 'pb_ratio': 1.2, 'eps': 4.2, 'roe': 0.074,
                 ...
                 '52w_high': 88.0, '52w_low': 60.0, 'div_yield_pct': 5.5,
        ...
        '2002': {'pe_ratio': 14.5, 'pb_ratio': 0.85, 'eps': 1.8, 'roe': 0.058,
                 ...
                 '52w_high': 32.5, '52w_low': 22.0, 'div_yield_pct': 5.0,
        ...
        '2412': {'pe_ratio': 23.5, 'pb_ratio': 2.5, 'eps': 5.2, 'roe': 0.105,
                 ...
                 '52w_high': 138.0, '52w_low': 112.0, 'div_yield_pct': 4.2,
        ...
        '2603': {'pe_ratio': 8.5, 'pb_ratio': 1.2, 'eps': 12.5, 'roe': 0.14,
                 ...
                 '52w_high': 155.0, '52w_low': 90.0, 'div_yield_pct': 8.5,
        ...
        '2615': {'pe_ratio': 7.8, 'pb_ratio': 1.0, 'eps': 8.2, 'roe': 0.125,
                 ...
                 '52w_high': 78.0, '52w_low': 45.0, 'div_yield_pct': 6.8,
        ...
        '2609': {'pe_ratio': 7.2, 'pb_ratio': 0.9, 'eps': 9.5, 'roe': 0.13,
                 ...
                 '52w_high': 82.0, '52w_low': 48.0, 'div_yield_pct': 7.2,
    ...
    if static:
        ...
        # ★ 修正：靜態備援的 div_yield_pct 也補入（若 TWSE/TPEx 未能取得殖利率）
        if 'div_yield_pct' not in result and static.get('div_yield_pct') is not None:
            result['div_yield_pct'] = static['div_yield_pct']
        if static:
...
def get_stock_news(ticker):
    ...
    try:
        ...
        for idx, q in enumerate(query_terms[:3]):   # 最多跑前3個查詢詞
            if len(articles) >= 20:
                break
            ...
            for attempt in range(1):
                try:
                    resp = req.get(
                        ...
                        timeout=8,         # 單次 8s，整體才不會超過前端 30s 限制
        ...
        # ── 備援：若 Google News 完全無結果，改抓 Yahoo Finance 新聞 ──
        if not articles:
            print(f'  [news] Google News 無結果，嘗試 Yahoo Finance 備援')
            try:
                import yfinance as yf
                yf_ticker_str = f'{ticker}.TW' if not ticker.startswith('^') else ticker
                yt = yf.Ticker(yf_ticker_str)
                yf_news = yt.news or []
                for item in yf_news[:20]:
                    ...
                    try:
                        ...
                        if ts:
                            pub = datetime.datetime.fromtimestamp(int(ts)).strftime('%a, %d %b %Y %H:%M:%S +0800')
                    except Exception:
                        pass
                    ...
                    if title and title not in seen_titles:
                        ...
                        articles.append({'title': title, 'link': link,
                                         'pubDate': pub, 'source': source, 'desc': desc})
                print(f'  [news] Yahoo Finance 備援取得 {len(articles)} 篇')
            except Exception as ye:
                print(f'  [news] Yahoo Finance 備援失敗: {ye}')
